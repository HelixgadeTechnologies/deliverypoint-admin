...
export default function Header() {
    ...
    return (
        <div className="bg-white py-4 px-10 border-b border-gray-200 flex justify-between items-center h-[92px]">
            <Heading heading="Admin Management" subtitle="Welcome back! Here's what's happening today." />
            <div className="flex gap-4 items-center">
                ...
                <div className="h-11 w-[150px] rounded-full border border-[#FF4D4F] px-[17px] py-2.5 flex justify-between items-center">
                    ...
                    <div onClick={() => updateSosAlert(prev => prev + 1)} className="size-5 rounded-full p-2 bg-[#FF4D4F] text-white text-sm font-bold flex justify-center items-center">
                        {sosAlert}
                    </div>
                </div>
                <NotificationsTab />
